						...
						<div class="case_left">
							<h1 class="page-title"><?
								...
								<div class="case_right_text">
									<p>Шкафы РЗА производства ООО «МРЗ» соответствуют требованиям нормативных документов: ГОСТ Р 51321.1-2007, ГОСТ Р  51317.6.5-2006, СТО 56947007-29.120.70.042-2010 и "Правила устройства электроустановок" (7 изд.). </p>
									...
									<p>Шкафы имеют степень защиты до IP54 по ГОСТ 14254-96 и предназначены для установки в ОПУ и РЩ электрических станций и подстанций с климатическими условиями соответствующими УХЛ4 по ГОСТ 15150-69. Шкафы могут быть изготовлены с иными характеристиками от указанных по конкретному проекту, в зависимости от требований в опросном листе.</p>
								</div>
