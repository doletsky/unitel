...
$config = array(
    ...
    3 => array(
        'name' => '4. Номинальный фазовый ток',
        'data' => array(
            'Ir1' => '1 А',
            'Ir2' => '5 А',
    ...
    4 => array(
        'name' => '5. Номинальный ток нулевой последовательности',
        'data' => array(
            'Ior1' => '1 А',
            'Ior2' => '5 А',
	...
	11 => array(
        'name' => '12. Цифровой стандарт',
        'data' => array(
            'MMS0' => 'Нет',
            'MMS1' => 'МЭК 61850',
            'MMS2' => 'МЭК 60870-5-103',
            'MMS3' => 'МЭК 60870-5-104',
            'MMS4' => 'Modbus RTU',
            'MMS5' => 'Modbus TCP',
...
if( isset($_REQUEST["is_perechen"]) && $_REQUEST["is_perechen"]){
	...
	$section->addText('Код конфигурации'.($_POST['product_id']==18?' МРЗ-3Л3':($_POST['product_id']==16?' МРЗ-1':'')).': '.$code, 'rStyle1', 'pStyle');
	$section->addTextBreak(2);
...
//    if($_REQUEST['product_id']==18){
//        $section->addText('14. Количество устройств: '.$_REQUEST['numbers_ustr'], null, 'pStyle');
//    }
    $section->addTextBreak(2);

    $section->addText('Дополнительные требования:', 'rStyle1', 'pStyle');
    $section->addText($_REQUEST["message_input"], null, 'pStyle');
